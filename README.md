...
- **Packet Handling:**
  ...
  - **Forwarding Decisions:**
    ...
    - In cases where no matching route is found (e.g., the destination is unreachable or the Time-to-Live (TTL) field expires), the router may generate ICMP messages such as "Time Exceeded" or "Destination Unreachable" to inform the sender about the issue.
